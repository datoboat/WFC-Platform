...
contract HelpRequestOrganizationsLogical {
    ...
    function requireDaoInvestigation(string calldata _investigationDataUrl, address _organizationAddress) external payable {
        ...
        require(msg.value > wfcManagment.getSetting(settingData), 'Not enough eth for investigation');
...
contract HelpRequestLogical is HelpRequestOrganizationsLogical {
