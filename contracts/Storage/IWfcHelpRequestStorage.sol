...
/**
 *@dev abstract contract for storage of help request variables
 */
contract IWfcHelpRequestStorage {
     ...
     */
    function addOrganization(address _organizationAddress, string calldata _dataUrlPropose, uint256 _status, bool _isUnderInvestigation, string calldata _dataUrlInvestigationRequest) external;
    ...
    /**
      ...
      */
    function addFundraisingProposal(bytes32 _line, address _organization, uint256 _softcap, uint256 _hardcap, address _currency, uint256 _timeout, address _destination, uint256 _proposalStatus, string calldata _fundraisingDataUrl) external;
